                ...
                if (prjname != "")
                {
                    ...
                    foreach (String file in otherfileslist)
                    {
                        if (file != "")
                        {
                            ...
                            else if (filename.Contains(".c") || filename.Contains(".cpp") || filename.Contains(".c++") || filename.Contains(".cs"))
                            {
                                imgindex2 = 13;
                            }
        ...
        public void CopyAllSourceFilesToSRCFolder()
        {
            ...
            if (projectlocationfolder != "")
            {
                if (Directory.Exists(projectlocationfolder + "\\src"))
                {
                    ...
                    {
                        String fileName = cpyfile.Substring(cpyfile.LastIndexOf("\\") +1 );
                        String newFilePath = getCurrentProjectLocationFolder() + "\\src\\" + fileName;

                       // MessageBox.Show(newFilePath, "Information");
                        //MessageBox.Show(cpyfile, "Information");
                        ...
                        {
                            if (File.Exists(cpyfile))
                            {
                                File.Copy(cpyfile, newFilePath);
...
//***********************************************************************************************************************************
        ...
        {
            LoadProject_Form njap = new LoadProject_Form(this);
            njap.ShowDialog();
        ...
        {
            String dir = getCurrentProjectLocationFolder();
            ...
            {
                //  AddFilesToProjectExplorerTreeView();
                AddFilesToProjectExplorerTreeViewFromOpenedProject(dir);
                WriteCurrentFileNames();
                CopyAllSourceFilesToSRCFolder();
                UpdateWindowsList_WindowMenu();
                myTabControl_SelectedIndexChanged(sender, e);
        ...
        /// </summary>
        /// <param name="projectfilename">current opened project file</param>
        /// 
        ...
        public void LoadDirectory(string Dir)
        {
            ...
            TreeNode tds = ProjectExplorerTreeView.Nodes.Add(di.Name);
            tds.Tag = di.FullName;
        ...
        private void LoadSubDirectories(string dir, TreeNode td)
        {
            ...
            {
                if (subdirectory != getCurrentProjectName())
                {
        ...
        public void  AddFilesToProjectExplorerTreeViewFromOpenedProject(String dir)
        {
            LoadDirectory(dir);
        }
        ...
        private void myTabControl_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (myTabControl.TabCount > 0)
            {
                ...
                if (tabpage.Text != "Start Page")
                {
                  ...
                  /*  if (tabpage.Text != "Start Page" || tabpage.Text != "Unit Tests")
                    {
        ...
        private void UnitTestTabControl_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (myTabControl.TabCount > 0)
            {
                TabPage tabpage = myTabControl.SelectedTab;
                ...
                if (tabpage.Text.Contains("*"))
                {
                    ...
                    if (dg == DialogResult.Yes)
                    {
                        ...
                        if (myTabControl.TabCount == 0)
                        {
                            ...
                            FilenameToolStripLabel.Text = "Oncf_Ut";
                        }
                    }
                    else
                    {
                        ...
                        {
                            File.WriteAllText(Application.StartupPath + "\\files\\files.slvjfile", "");
                            FilenameToolStripLabel.Text = "Oncf-Ut";
                        }
                    }
                }
        ...
        private void Edit_CommentLine_SingleLineMenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControl.TabCount > 0)
            {
                if (myTabControl.SelectedTab.Text != "Start Page")
                {
                    ...
                    var texteditor = (TextEditorControl)myTabControl.TabPages[select_index].Controls[0];
                    TabPage tabpage = myTabControl.SelectedTab;
                    if (tabpage.Text.Contains(".cs") || tabpage.Text.Contains(".c") || tabpage.Text.Contains(".cpp") || tabpage.Text.Contains("cs") || tabpage.Text.Contains(".js") || tabpage.Text.Contains(".css") || tabpage.Text.Contains(".sql") || tabpage.Text.Contains(".xml"))
                    {
        ...
        private void Edit_CommentLine_MultiLineMenuItem_Click(object sender, EventArgs e)
        {
            if (myTabControl.TabCount > 0)
            {
                if (myTabControl.SelectedTab.Text != "Start Page")
                {
                    ...
                    var texteditor = (TextEditorControl)myTabControl.TabPages[select_index].Controls[0];
                    TabPage tabpage = myTabControl.SelectedTab;
                    if (tabpage.Text.Contains(".cs") || tabpage.Text.Contains(".c") || tabpage.Text.Contains(".cpp") || tabpage.Text.Contains("cs") || tabpage.Text.Contains(".js") || tabpage.Text.Contains(".css") || tabpage.Text.Contains(".sql"))
                    {
                        int sel = texteditor.ActiveTextAreaControl.TextArea.Caret.Offset;
                        texteditor.Document.Insert(sel, "/*       */");
                        texteditor.ActiveTextAreaControl.TextArea.Caret.Column = sel;
...
//***********************************************************************************************************************************
        ...
        // Compilation Phase : 
        public List<String> CopyAllSourceFilesToCLASSESFolder()
        {
            String projectfile = ReadCurrentProjectFileName();
            List<String> mylist = new List<String> { };

            // String csLists = "";
            List<String> csLists = new List<String> { };
            ...
            if (projectlocationfolder != "")
            {
                if (Directory.Exists(projectlocationfolder + "\\classes"))
                {
                    ...
                    foreach (String cpyfile in mylist)
                    {
                        String f1 = cpyfile.Substring(cpyfile.LastIndexOf("\\") + 1);


                        if (f1.Substring(f1.LastIndexOf(".")) == ".cs" && f1.Substring(f1.LastIndexOf(".")) != ".resx" && !f1.Contains("Test"))
                        {
                            String fileName = cpyfile.Substring(cpyfile.LastIndexOf("\\") + 1);
                            String newFilePath = getCurrentProjectLocationFolder() + "\\classes\\" + fileName;

                            //MessageBox.Show(newFilePath, "Information");
                            //MessageBox.Show(cpyfile, "Information");


                            String file2 = cpyfile.Replace("srcclasses", "classes");
                            ...
                            if (!File.Exists(newFilePath))
                            {
                                if (File.Exists(cpyfile))
                                {
                                    ...
                                    //csLists = csLists +  newFilePath + "\n";
                                    // MessageBox.Show(csLists, "Information");
                                    csLists.Add(newFilePath);
                ...
                else
                {
                    ...
                    foreach (String cpyfile in mylist)
                    {
                        ...
                        if (f1.Substring(f1.LastIndexOf(".")) == ".cs" && f1.Substring(f1.LastIndexOf(".")) != ".resx" && !f1.Contains("Test"))
                        {
                            ...
                            String fileName = cpyfile.Substring(cpyfile.LastIndexOf("\\") + 1);
                            String newFilePath = getCurrentProjectLocationFolder() + "\\src\\" + fileName;
                            newFilePath = newFilePath.Remove(0);
            ...
            String[] referenceAssemblies = { "System.dll", "System.Drawing.dll", "System.Windows.Forms.dll", "ICSharpCode.TextEditor.dll", "System.Xml.dll", "System.IO.dll", "System.ComponentModel.dll" , "System.Data.dll" , "System.linq.dll"  };
                ...
                if (results.Errors.Count > 0)
                {
                    ...
                    ErrorTextBox.Text = ErrorTextBox.Text +
                                    ...
                                    ", '" + CompErr.ErrorText + ", Error File: " + CompErr.FileName +  ";" +
                ...
                ErrorTextBox.Text = "Success! Huraaaa";
        ...
        /// <summary>
        ///  Generating and Compiling Unit Tests Progrmmaticcly : 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        /// 
        ...
        private void ProjectExplorerTreeView_NodeMeeouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
                            ...
                            foreach (String file in mylist)
                            {
                                ...
                                if (nodetext == filename)
                                {
                                    ...
                                    //read each file text and add it to textEditor
                                       ...
                                       tabpage.Text = ProjectExplorerTreeView.SelectedNode.Text.ToString();
                                       myTabControl.TabPages.Add(tabpage);
                                       myTabControl.SelectedTab = tabpage; 
          ...
          /*  String parentNodeText = ProjectExplorerTreeView.SelectedNode.Parent.Text;
            String selectednodetext = ProjectExplorerTreeView.SelectedNode.Text;
                    ...
                    while (xmlreader.Read())
                    {
                        if (xmlreader.IsStartElement())
                        {
                            switch (xmlreader.Name.ToString())
                            {
                                ...
                                case "ProjectLocationFolder":
                                    NodePath = xmlreader.ReadString() + "\\srcclasses";
                                    break;
                            }
                        }
                    }
            ...
            String node = NodePath + "//" + selectednodetext;
            ...
            //read each file text and add it to textEditor
            StreamReader filereader = new StreamReader(node);
            tabpage.textEditor.Text = filereader.ReadToEnd();
            filereader.Close();
...
//***********************************************************************************************************************************
 ...
 //***********************************************************************************************************************************
        ...
        private void startpagepanel_Panel2_Paint(object sender, PaintEventArgs e)
        {

        }

        private void Load_Project_Btn_Click(object sender, EventArgs e)
        {
            LoadProject_Form njap = new LoadProject_Form(this);
            njap.ShowDialog();
            ...
            if (ReadCurrentProjectFileName() != "" && File.Exists(ReadCurrentProjectFileName()))
            {
                ...
                if (File.Exists(projectfilename))
                {
                    using (XmlReader xmlreader = XmlReader.Create(projectfilename))
                    {
                        while (xmlreader.Read())
                        {
                            if (xmlreader.IsStartElement())
                            {
                                ...
                                {
                                    case "ProjectName":
                                        projectname = xmlreader.ReadString();
                                        break;

                                    case "JavaClassFile":
                                        javaclassfilename = xmlreader.ReadString();
                                        break;
                                }
                            }
                        }
                    ...
                    FilenameToolStripLabel.Text = "Oncf_Ut";
                    CopyAllSourceFilesToCLASSESFolder();
                    CopyAllSourceFilesToSRCFolder();
                    copyTestFolderDirectoryToProject();
                    WriteCurrentFileNames();
      ...
      /*  public List<String> CreateClassesInTestFolder()
        {
            String projectfile = ReadCurrentProjectFileName();
            String projectfilename = ReadCurrentProjectFileName();
            String projectlocationfolder = getCurrentProjectLocationFolder();
            ...
            List<String> csLists = CopyAllSourceFilesToCLASSESFolder();
            List<String> unitTestClasses = new List<String> { };



            if (projectlocationfolder != "")
            {
                if (!Directory.CreateDirectory(projectlocationfolder + "\\TestFolder").Exists)
                {
                    Directory.CreateDirectory(projectlocationfolder + "\\TestFolder");
                }

                if (Directory.Exists(projectlocationfolder + "\\TestFolder"))
                {
                    //delete all files from src folder
                    String[] files = Directory.GetFiles(projectlocationfolder + "\\TestFolder");

                    foreach (String file in files)
                    {
                        File.Delete(file);
                    }
                    //copy all files in mylist from srcclasses folder to TestFolder
                    foreach (String file in csLists)
                    {
                        FileInfo fi = new FileInfo(file);
                        String newTestFileName = fi.Name;
                        if (fi.Name.Contains(".cs") && !fi.Name.Contains(".Designer") && !fi.Name.Contains(".resx"))
                        {

                            if (!File.Exists(projectlocationfolder + "\\TestFolder\\Test" + newTestFileName))
                            {
                                FileStream m = File.Create(projectlocationfolder + "\\TestFolder\\Test" + newTestFileName);

                                XmlDocument xmldoc = new XmlDocument();
                                xmldoc.Load(projectfilename);
                                XmlNode packnamenode = xmldoc.CreateNode(XmlNodeType.Element, "JavaClassFile", null);
                                packnamenode.InnerText = m.Name;
                                xmldoc.DocumentElement.AppendChild(packnamenode);
                                xmldoc.Save(projectfilename);
                            ...
                            unitTestClasses.Add(projectlocationfolder + "\\TestFolder\\Test" + newTestFileName + "\n");
                        }
                    }
                }
        ...
        public void  CreateClassesInTestFolder(String cls)
        {
            String projectfile = ReadCurrentProjectFileName();
            String projectfilename = ReadCurrentProjectFileName();
            String projectlocationfolder = getCurrentProjectLocationFolder();
            List<String> csLists = CopyAllSourceFilesToCLASSESFolder();
            FileInfo clsfile = new FileInfo(cls);
            String clsFileName = clsfile.Name;
            ...
            if (projectlocationfolder != "")
            {
                ...
                if (Directory.Exists(projectlocationfolder + "\\TestFolder"))
                {
                    List<String> files = Directory.GetFiles(projectlocationfolder + "\\TestFolder").ToList();

                    //Create a class if is not exist :
                    ...
                    foreach (String file in csLists)
                    {
                        ...
                        if (fi.Name.Contains(".cs") && !newTestFileName.Contains(".Designer") && !newTestFileName.Contains(".resx") && newTestFileName == clsFileName)
                        {

                            if (!File.Exists(projectlocationfolder + "\\TestFolder\\Test" + newTestFileName))
                            {
                                m = File.Create(projectlocationfolder + "\\TestFolder\\Test" + newTestFileName);
                                XmlDocument xmldoc = new XmlDocument();
                                xmldoc.Load(projectfilename);
                                XmlNode packnamenode = xmldoc.CreateNode(XmlNodeType.Element, "JavaClassFile", null);
                                packnamenode.InnerText = m.Name;
                ...
                else
                {
                    ...
                    foreach (String file in csLists)
                    {
                        ...
                        if (fi.Name.Contains(".cs") && !newTestFileName.Contains(".Designer") && !newTestFileName.Contains(".resx") && newTestFileName == cls)
                        {
        ...
        public void  copyTestFolderDirectoryToProject()
        {
        }
        
        private void uniTestsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            copyTestFolderDirectoryToProject();

        }

        private void addUnitTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CreateClassesInTestFolder(ProjectExplorerTreeView.SelectedNode.FullPath);
        ...
        private void writeUnitTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            // Selection De La TabPage UnitTesting :
            System.Windows.Forms.TabControl.TabPageCollection tabcoll = myTabControl.TabPages;
            TabPage newPage = tabcoll["UnitTesting"];
            myTabControl.SelectedTab = newPage;
            ...
            int a = 0;
            System.Windows.Forms.TabControl.TabPageCollection tabcoll1 = unitTestTabControl.TabPages;
            tabpagestextlist.Clear();
            ...
            foreach (TabPage tabpage in tabcoll1)
            {
                ...
                {
                    tabpagestextlist.Add(tabstr);
                    unitTestTabControl.SelectedTab = tabpage;
                    myTabControl_SelectedIndexChanged(sender, e);
                }
            ...
            int tc = unitTestTabControl.TabCount;
                    ...
                    foreach (String file in mylist)
                    {
                        ...
                        if (nodetext == filename)
                        {
                            ...
                            if (checkstr.Contains(file))
                            {
                                ...
                                mytabpage.textEditor.Text = filetext;
                                mytabpage.textEditor.ContextMenuStrip = textEditorContextMenuStrip;
                                unitTestTabControl.TabPages.Add(mytabpage);
                                unitTestTabControl.SelectedTab = mytabpage;
                                ...
                                TabPage seltab = unitTestTabControl.SelectedTab;
                                if (seltab.Text.Contains("*"))
                                {
                                    String str = seltab.Text.Remove(seltab.Text.Length - 1);
                                    seltab.Text = str;
        ...
        private void File_CloseUnitTestMenuItem_Click(object sender, EventArgs e)
        {

            if (unitTestTabControl.TabCount > 0)
            {
                TabPage tabpage = unitTestTabControl.SelectedTab;
                ...
                if (tabpage.Text.Contains("*"))
                {
                    ...
                    {
                        //save file before close
                        File_CloseUnitTestMenuItem_Click(sender, e);
                        //remove file name from project file
                        RemoveVisualFilesTextFromProjectFile(FilenameToolStripLabel.Text);
                        //remove tab
                        unitTestTabControl.TabPages.Remove(tabpage);

                        RemoveFileNamesByRemovingTabs();
                        UpdateWindowsList_WindowMenu();
                        SetVisibilityOfToolStripButtons();
                        UnitTestTabControl_SelectedIndexChanged(sender, e);
        ...
        public void File_SaveUnitTestsMenuItem_Click(object sender, EventArgs e)
        {
            if (unitTestTabControl.TabCount > 0 || unitTestTabControl.SelectedTab.Text != "Start Page")
            {
                if (FilenameToolStripLabel.Text.Contains("\\"))
                {
                    String s = FilenameToolStripLabel.Text;
                    ...
                    if (s2 == s3)
                    {
                        if (tabpage.Text.Contains("*"))
                        {
                            ...
                            if (File.Exists(filename))
                            {
                                var texteditor = (TextEditorControl)unitTestTabControl.TabPages[unitTestTabControl.SelectedIndex].Controls[0];
                                RichTextBox rtb = new RichTextBox();
                                rtb.Text = texteditor.Text;
                                File.WriteAllText(filename, "");
                                StreamWriter strwriter = System.IO.File.AppendText(filename);
        ...
        {
            File_SaveUnitTestsMenuItem_Click(sender, e);

        }

        /// <summary>
        /// Compiling Unit Test Programmaticcl : Using CodeDomProvider  ; 
        /// 
        /// </summary>
        /// <returns></returns>
        /// 

        public List<String> getCurrentTestClasses()
        {
        ...
        public String getCurrentProjectDll()
        {
            ...
            String dllPath = parameters.OutputAssembly = projectLocation + "\\ProjectUnderTest.dll";
            ...
            {
                MessageBox.Show("dLL Generated Succefully ", " Information");
            }
        ...
        public String getTestClassesCompiledDll()
        {
            String projectLocation = getCurrentProjectLocationFolder();
            String[] csFiles = getCurrentTestClasses().ToArray();


            String[] referenceAssemblies = { "System.dll", "System.Drawing.dll", "System.Windows.Forms.dll", "ICSharpCode.TextEditor.dll", "System.Xml.dll", "System.IO.dll", "System.ComponentModel.dll", "System.Data.dll", "System.linq.dll"  , getCurrentProjectDll()  , "Nunit.Core.dll" , "nunit.framework.dll" };
            ...
            //Make sure we generate an EXE, not a DLL
            parameters.GenerateExecutable = false;
            String dllPath = parameters.OutputAssembly = projectLocation + "\\UnitTests.dll";
            ...
            {
                MessageBox.Show("Uni Tests dLL Generated Succefully ", " Information");
            }
        ...
        public void run(String pathToTestLibrary)
        {
            ...
            ErrorTextBox.Text = result.ResultState.ToString();
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            String dllPath = projectLocation + "\\UnitTests.dll"; 
            getTestClassesCompiledDll();
            run(dllPath);
        }
