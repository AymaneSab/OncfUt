 ...
 ******Copyright (C) 2016 Pritam Zope*****
  ...
  <copyright file="PrintHelper.cs" company="">
...
namespace Silver_J
{
    public static class PrintHelper
    {
        ...
        {
            TextEditorPrintHelper helper = new TextEditorPrintHelper(control);
            helper.PrintRTF();
        }
    }

    public class TextEditorPrintHelper
    {
        RichTextBox control;

        public TextEditorPrintHelper(RichTextBox controlToPrint)
        {
